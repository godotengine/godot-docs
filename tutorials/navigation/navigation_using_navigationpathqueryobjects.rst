...
For the available customization options see further below and also see the class doc of the parameters.
...
This reuse of the same objects avoids performance implications from frequent object creation or memory allocations.

The following script creates the objects and provides a ``query_path()`` function to creat new navigation paths.
