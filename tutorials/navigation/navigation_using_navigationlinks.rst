...
A navigation link provides automated movement through the link. If it does not appear to be working, try changing the ``start_position`` and ``end_position`` of the link.
