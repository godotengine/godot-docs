...
-------------------------
The :ref:`OpenXRRenderModels<class_OpenXRRenderModels>` node can be used
to automate most of the render models functionality. 
...
In this setup we find an :ref:`OpenXRRenderModels<class_OpenXRRenderModels>`
...
Finally we see another :ref:`OpenXRRenderModels<class_OpenXRRenderModels>`
...
.. list-table:: Title
   ...
   * - render_model_get_top_level_path
     - Returns the toplevel path associated with this
       render model (if any).
       Use the ``render_model_toplevel_path_changed``
