...
.. warning::
    ...
    This implementation is not actively maintained. As it allows maintainers and reviewers the ability to test stereoscopic rendering without the need for expensive XR hardware, this XR interface is mostly used for diagnostic purposes.
