...
converted via the inverse projection matrix. Note that as of now, a bug in the 
GLES3 renderer requires a light in the scene with shadows disabled and the contact
setting set to 1 for the depth buffer to work properly.
