...
::
    ...
    func _process(delta):
        var ball_pos = get_node("ball").global_position
        var left_rect = Rect2( get_node("left").global_position - pad_size*0.5, pad_size )
        var right_rect = Rect2( get_node("right").global_position - pad_size*0.5, pad_size )
...
::
        ...
        get_node("ball").global_position = ball_pos
