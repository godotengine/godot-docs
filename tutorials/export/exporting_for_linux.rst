...
today, all modern Intel and AMD processors as of writing are x86_64.

x86_32 will give you an 32 bit executable that can run on 32bit only distributions
of Linux as well as some modern distributions which are 64bit. It is NOT recommended
...
distributions, such as Fedora, have been discussing removing their 32 bit libraries
...
versions used 32 bit arm processors). If you're uploading to a platform that
...
loongarch64 is for 64 bit loongarch processors. All of these architectures are
