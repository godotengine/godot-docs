...
x86_32 will give you an 32 bit executable that can run on 32bit only versions of
...
Microsofts' Prisim emulator. Executables made using this option will NOT run on
...
providing an ARM version. Prisim emulation is far from perfect, and Godot does not
