...
.. note::
    ...
    If using version 1.1.0 or earlier of the plugin, it is important to
    add a script on the root node and call ``$FPSController.initialise()``.
    This is no longer required with version 1.1.1 and later.
