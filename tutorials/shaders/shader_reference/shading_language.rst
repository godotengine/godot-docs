...
+----------------------+--------------------------------------------------+------------------------------------------------------------------------------------+
| *any*                | no_storage                                       | The value of the uniform is not saved to the :ref:`class_ShaderMaterial`           |
|                      |                                                  | resource file. Useful for uniforms that are set at runtime, especially from a      |
|                      |                                                  | ``@tool`` script.                                                                  |
|                      |                                                  | This is the equivalent of disabling                                                |
|                      |                                                  | :ref:`PROPERTY_USAGE_STORAGE <class_@GlobalScope_constant_PROPERTY_USAGE_STORAGE>` |
|                      |                                                  | in GDScript.                                                                       |
+----------------------+--------------------------------------------------+------------------------------------------------------------------------------------+
| *any*                | no_editor                                        | The uniform is not shown in the editor's inspector. Useful for uniforms            |
|                      |                                                  | that are intended to only be set through code.                                     |
|                      |                                                  | This is the equivalent of disabling                                                |
|                      |                                                  | :ref:`PROPERTY_USAGE_EDITOR <class_@GlobalScope_constant_PROPERTY_USAGE_EDITOR>`   |
|                      |                                                  | in GDScript.                                                                       |
+----------------------+--------------------------------------------------+------------------------------------------------------------------------------------+
