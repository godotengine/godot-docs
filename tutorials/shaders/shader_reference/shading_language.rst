...
.. note::
    ...
    a texture arrar using a per-instance uniform, as sampler arrays can only be indexed by
    compile-time constant expressions. This can affect shaders compiled with the Compatibility
    renderer on some particular OS/GPU combinations.
