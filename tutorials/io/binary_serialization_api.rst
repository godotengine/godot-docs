...
| 8        | 4        | Float   | basis.x.y     |
+----------+----------+---------+---------------+
| 12       | 4        | Float   | basis.x.z     |
+----------+----------+---------+---------------+
| 16       | 4        | Float   | basis.y.x     |
+----------+----------+---------+---------------+
| 20       | 4        | Float   | basis.y.y     |
+----------+----------+---------+---------------+
| 24       | 4        | Float   | basis.y.z     |
+----------+----------+---------+---------------+
| 28       | 4        | Float   | basis.z.x     |
+----------+----------+---------+---------------+
| 32       | 4        | Float   | basis.z.y     |
+----------+----------+---------+---------------+
| 36       | 4        | Float   | basis.z.z     |
+----------+----------+---------+---------------+
| 40       | 4        | Float   | origin.x      |
+----------+----------+---------+---------------+
| 44       | 4        | Float   | origin.y      |
