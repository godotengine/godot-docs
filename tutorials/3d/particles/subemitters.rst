...
Particle systems from instantiated scenes can be set as sub-emitters too, as long
as ``Editable Children`` is enabled on the instantiated scene. This also works the other
