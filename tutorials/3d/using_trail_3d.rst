...
.. note::
    ...
    brighter colors out of this property, set the material mode to **Custom**,
    and in the custom shader, add a brightness multiplier ``float``
...
.. note::
    ...
    There is a hard limit of 65,536 vertices per trail. If this limit is reached, a
    warning is printed and the trail will look incorrect. In this case, you should increase
    **Min Section Length**, or decrease the trail's lifetime or maximum length to reduce its
    vertex count.
