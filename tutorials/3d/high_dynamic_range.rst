...
in the current :ref:`Environment <api:class_Environment>` (more on that below).
...
HDR settings can be found in the :ref:`Environment <api:class_Environment>`
resource. Most of the time, these are found inside a
:ref:`WorldEnvironment <api:class_WorldEnvironment>`
