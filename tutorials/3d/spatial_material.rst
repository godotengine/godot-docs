...
There are four ways to add a ``SpatialMaterial`` to an object. It can be added in
...
mesh. As an example this could be used to put a transparent shield effect on a mesh.
