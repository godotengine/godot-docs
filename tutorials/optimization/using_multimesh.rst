...
A :ref:`MultiMesh<api:class_MultiMesh>` is a single draw primitive that can draw up to millions
...
to the shader can be provided via textures (there are floating point :ref:`Image<api:class_Image>` formats
...
:ref:`VisualServer.multimesh_set_as_bulk_array() <api:class_VisualServer_method_multimesh_set_as_bulk_array>`
...
controlled with the :ref:`MultiMesh.visible_instance_count <api:class_MultiMesh_property_visible_instance_count>`
