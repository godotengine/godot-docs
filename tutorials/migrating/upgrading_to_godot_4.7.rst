...
Method ``add_image`` renames ``width_in_percent`` parameter to ``width_unit`` and changes type from ``bool`` to ``RichTextLabel.ImageUnit``        |✔️|                 |✔️ with compat|      |✔️ with compat|      `GH-112617`_
Method ``add_image`` renames ``height_in_percent`` parameter to ``height_unit`` and changes type from ``bool`` to ``RichTextLabel.ImageUnit``      |✔️|                 |✔️ with compat|      |✔️ with compat|      `GH-112617`_
...
Method ``update_image`` renames ``width_in_percent`` parameter to ``width_unit`` and changes type from ``bool`` to ``RichTextLabel.ImageUnit``     |✔️|                 |✔️ with compat|      |✔️ with compat|      `GH-112617`_
Method ``update_image`` renames ``height_in_percent`` parameter to ``height_unit`` and changes type from ``bool`` to ``RichTextLabel.ImageUnit``   |✔️|                 |✔️ with compat|      |✔️ with compat|      `GH-112617`_
=================================================================================================================================================  ===================  ====================  ====================  ============
...
.. note::
    ...
    The default ``area_mask`` for ``AudioStreamPlayer`` was changed to ``0`` (disabled) (`GH-107679`_).
...
.. note::
    ...
    The device ID for mouse and keyboard has changed from ``0`` because some joypads may use it (`GH-116274`_).
