...
| Contents               |                          |                                |                      |
+========================+==========================+================================+======================+
| `History`_             | `Built-in types`_        | `Statements and control flow`_ | `Tool mode`_         |
+------------------------+--------------------------+--------------------------------+----------------------+
| `Example of GDScript`_ | `Variables`_             | `if/else/elif`_                | `Memory management`_ |
+------------------------+--------------------------+--------------------------------+----------------------+
| `Identifiers`_         | `Casting`_               | `while`_                       | `Signals`_           |
+------------------------+--------------------------+--------------------------------+----------------------+
| `Keywords`_            | `Constants`_             | `for`_                         | `Assert keyword`_    |
+------------------------+--------------------------+--------------------------------+----------------------+
| `Operators`_           | `Enums`_                 | `match`_                       |                      |
+------------------------+--------------------------+--------------------------------+----------------------+
| `Literals`_            | `Functions`_             | `Classes`_                     |                      |
+------------------------+--------------------------+--------------------------------+----------------------+
| `Annotations`_         | `Referencing functions`_ | `Inheritance`_                 |                      |
+------------------------+--------------------------+--------------------------------+----------------------+
| `Comments`_            | `Lambda functions`_      | `Class constructor`_           |                      |
+------------------------+--------------------------+--------------------------------+----------------------+
| `Line continuation`_   | `Static functions`_      | `Exports`_                     |                      |
+------------------------+--------------------------+--------------------------------+----------------------+
