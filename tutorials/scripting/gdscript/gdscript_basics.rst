...
=======
The following is the list of supported operators, their precedence, and `associativity <https://en.wikipedia.org/wiki/Operator_associativity>`_.
>>>>>>> origin/docs/op-assoc

+---------------------------------------+-----------------------------------------------------------------------------+-------------------+
| **Operator**                          | **Description**                                                             | **Associativity** |
+=======================================+=============================================================================+===================+
| ``(`` ``)``                           | Grouping (highest priority)                                                 | N/A               |
|                                       |                                                                             |                   |
...
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| ``foo()``                             | Function call                                                               | Left              |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| ``await x``                           | `Awaiting for signals or coroutines`_                                       | Right             |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| | ``x is Node``                       | Type checking                                                               | Left              |
| | ``x is not Node``                   |                                                                             |                   |
...
| ``~x``                                | Bitwise NOT                                                                 | Right             |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| | ``+x``                              | Identity / Negation                                                         | Right             |
| | ``-x``                              |                                                                             |                   |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| | ``x * y``                           | Multiplication / Division / Remainder                                       | Left              |
| | ``x / y``                           |                                                                             |                   |
...
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| | ``x + y``                           | Addition (or Concatenation) / Subtraction                                   | Left              |
| | ``x - y``                           |                                                                             |                   |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| | ``x << y``                          | Bit shifting                                                                | Left              |
| | ``x >> y``                          |                                                                             |                   |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| ``x & y``                             | Bitwise AND                                                                 | Left              |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| ``x ^ y``                             | Bitwise XOR                                                                 | Left              |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| ``x | y``                             | Bitwise OR                                                                  | Left              |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| | ``x == y``                          | Comparison                                                                  | Left              |
...
| | ``x >= y``                          |                                                                             |                   |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| | ``x in y``                          | Inclusion checking                                                          | Left              |
| | ``x not in y``                      |                                                                             |                   |
|                                       | ``in`` is also used with the for_ keyword as part of the syntax.            |                   |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| | ``not x``                           | Boolean NOT and its :ref:`unrecommended <boolean_operators>` alias          | Right             |
| | ``!x``                              |                                                                             |                   |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| | ``x and y``                         | Boolean AND and its :ref:`unrecommended <boolean_operators>` alias          | Left              |
| | ``x && y``                          |                                                                             |                   |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| | ``x or y``                          | Boolean OR and its :ref:`unrecommended <boolean_operators>` alias           | Left              |
| | ``x || y``                          |                                                                             |                   |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| ``true_expr if cond else false_expr`` | Ternary if/else                                                             | Right             |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| ``x as Node``                         | `Type casting <casting_>`_                                                  | Left              |
+---------------------------------------+-----------------------------------------------------------------------------+-------------------|
| | ``x = y``                           | Assignment (lowest priority)                                                | Left              |
| | ``x += y``                          |                                                                             |                   |
