...
This warning may appear there is code in a function that can never be reached because all possible code paths before it would hit a ``return`` statement and leave the function:
