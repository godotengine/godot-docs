...
+-----------------------+-------------------------------+------------------------------+----------------------------------+
| Distraction Free Mode | :kbd:`Ctrl + Shift + F11`     | :kbd:`Cmd + Shift + D`       | ``editor/distraction_free_mode`` |
+-----------------------+-------------------------------+------------------------------+----------------------------------+
...
+---------------------------+---------------------------------+----------------------------------+------------------------------------------------------+
| Go to Line                | :kbd:`Ctrl + G`                 | :kbd:`Cmd + L`                   | ``script_text_editor/goto_line``                     |
+---------------------------+---------------------------------+----------------------------------+------------------------------------------------------+
...
| Action name     | Windows, Linux   | macOS            | Editor setting               |
+=================+==================+==================+==============================+
| Previous Floor  | :kbd:`1`         | :kbd:`1`         | ``grid_map/previous_floor``  |
+-----------------+------------------+------------------+------------------------------+
| Next Floor      | :kbd:`3`         | :kbd:`3`         | ``grid_map/next_floor``      |
+-----------------+------------------+------------------+------------------------------+
| Edit X Axis     | :kbd:`Shift + Z` | :kbd:`Shift + Z` | ``grid_map/edit_x_axis``     |
+-----------------+------------------+------------------+------------------------------+
| Edit Y Axis     | :kbd:`Shift + X` | :kbd:`Shift + X` | ``grid_map/edit_y_axis``     |
+-----------------+------------------+------------------+------------------------------+
| Edit Z Axis     | :kbd:`Shift + C` | :kbd:`Shift + C` | ``grid_map/edit_z_axis``     |
+-----------------+------------------+------------------+------------------------------+
| Transform       | :kbd:`T`         | :kbd:`T`         | ``grid_map/transform_tool``  |
+-----------------+------------------+------------------+------------------------------+
| Selection       | :kbd:`Q`         | :kbd:`Q`         | ``grid_map/selection_tool``  |
+-----------------+------------------+------------------+------------------------------+
| Erase           | :kbd:`W`         | :kbd:`W`         | ``grid_map/erase_tool``      |
+-----------------+------------------+------------------+------------------------------+
| Paint           | :kbd:`E`         | :kbd:`E`         | ``grid_map/paint_tool``      |
+-----------------+------------------+------------------+------------------------------+
| Pick            | :kbd:`R`         | :kbd:`R`         | ``grid_map/pick_tool``       |
+-----------------+------------------+------------------+------------------------------+
| Fill            | :kbd:`Z`         | :kbd:`Z`         | ``grid_map/fill_tool``       |
+-----------------+------------------+------------------+------------------------------+
| Move            | :kbd:`X`         | :kbd:`X`         | ``grid_map/move_tool``       |
+-----------------+------------------+------------------+------------------------------+
| Duplicate       | :kbd:`C`         | :kbd:`C`         | ``grid_map/duplicate_tool``  |
+-----------------+------------------+------------------+------------------------------+
| Delete          | :kbd:`V`         | :kbd:`V`         | ``grid_map/delete_tool``     |
+-----------------+------------------+------------------+------------------------------+
