...
- **NOTIFICATION_RESET_PHYSICS_INTERPOLATION** = **28** --- Notification received when :ref:`reset_physics_interpolation<class_Node_method_reset_physics_interpolation>` is called on the node or parent nodes.
