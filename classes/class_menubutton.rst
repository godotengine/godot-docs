...
.. table::
   ...
   +-----------------------------------------------+-----------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+
   | :ref:`bool<class_bool>`                       | :ref:`popup/item_{index}/indeterminate<class_MenuButton_property_popup/item_{index}/indeterminate>` | ``false``                                                                     |
   +-----------------------------------------------+-----------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+
...
\ **Note:** An item cannot be both in a checked and indeterminate state, so if ``checked`` is set to ``true``, :ref:`popup/item_{index}/indeterminate<class_MenuButton_property_popup/item_{index}/indeterminate>` will be set to ``false``.
...
.. _class_MenuButton_property_popup/item_{index}/indeterminate:

.. rst-class:: classref-property

:ref:`bool<class_bool>` **popup/item_{index}/indeterminate** = ``false`` :ref:`🔗<class_MenuButton_property_popup/item_{index}/indeterminate>`

If ``true``, the item at ``index`` is in an indeterminate state.

\ **Note:** ``index`` is a value in the ``0 .. item_count - 1`` range.

\ **Note:** An item cannot be both in a checked and indeterminate state, so if ``indeterminate`` is set to ``true``, :ref:`popup/item_{index}/checked<class_MenuButton_property_popup/item_{index}/checked>` will be set to ``false``.
