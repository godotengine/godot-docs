...
.. table::
   ...
   +---------------------------------------+------------------------------------------------------------------------------------------+-------------------------------------+
   | :ref:`AudioStream<class_AudioStream>` | :ref:`focus_sound<class_Tree_theme_sound_focus_sound>`                                   |                                     |
   +---------------------------------------+------------------------------------------------------------------------------------------+-------------------------------------+
   | :ref:`AudioStream<class_AudioStream>` | :ref:`item_hovered_sound<class_Tree_theme_sound_item_hovered_sound>`                     |                                     |
   +---------------------------------------+------------------------------------------------------------------------------------------+-------------------------------------+
   | :ref:`AudioStream<class_AudioStream>` | :ref:`item_selected_sound<class_Tree_theme_sound_item_selected_sound>`                   |                                     |
   +---------------------------------------+------------------------------------------------------------------------------------------+-------------------------------------+
...
.. _class_Tree_theme_sound_focus_sound:

.. rst-class:: classref-themeproperty

:ref:`AudioStream<class_AudioStream>` **focus_sound** :ref:`🔗<class_Tree_theme_sound_focus_sound>`
...
.. _class_Tree_theme_sound_item_hovered_sound:

.. rst-class:: classref-themeproperty

:ref:`AudioStream<class_AudioStream>` **item_hovered_sound** :ref:`🔗<class_Tree_theme_sound_item_hovered_sound>`
...
.. _class_Tree_theme_sound_item_selected_sound:

.. rst-class:: classref-themeproperty

:ref:`AudioStream<class_AudioStream>` **item_selected_sound** :ref:`🔗<class_Tree_theme_sound_item_selected_sound>`
