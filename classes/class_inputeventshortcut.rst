...
.. XML source: https://github.com/godotengine/godot/tree/4.0/doc/classes/InputEventShortcut.xml.
...
InputEventShortcut is a special event that can be received in :ref:`Node._unhandled_key_input<class_Node_method__unhandled_key_input>`. It is typically sent by the editor's Command Palette to trigger actions, but can also be sent manually using :ref:`Viewport.push_unhandled_input<class_Viewport_method_push_unhandled_input>`.
