...
.. DO NOT EDIT THIS FILE, but the PhysicsServer3D.xml source instead.
...
+--------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| :ref:`AreaSpaceOverrideMode<enum_PhysicsServer3D_AreaSpaceOverrideMode>` | :ref:`area_get_space_override_mode<class_PhysicsServer3D_method_area_get_space_override_mode>` **(** :ref:`RID<class_RID>` area **)** |const|                                                                                                                                                  |
+--------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+--------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| void                                                                     | :ref:`area_set_area_monitor_callback<class_PhysicsServer3D_method_area_set_area_monitor_callback>` **(** :ref:`RID<class_RID>` area, :ref:`Object<class_Object>` receiver, :ref:`StringName<class_StringName>` method **)**                                                                    |
+--------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+--------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| void                                                                     | :ref:`area_set_monitor_callback<class_PhysicsServer3D_method_area_set_monitor_callback>` **(** :ref:`RID<class_RID>` area, :ref:`Object<class_Object>` receiver, :ref:`StringName<class_StringName>` method **)**                                                                              |
+--------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+--------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| void                                                                     | :ref:`area_set_space_override_mode<class_PhysicsServer3D_method_area_set_space_override_mode>` **(** :ref:`RID<class_RID>` area, :ref:`AreaSpaceOverrideMode<enum_PhysicsServer3D_AreaSpaceOverrideMode>` mode **)**                                                                           |
+--------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
- **JOINT_TYPE_PIN** = **0** --- The :ref:`Joint3D<class_Joint3D>` is a :ref:`PinJoint3D<class_PinJoint3D>`.

- **JOINT_TYPE_HINGE** = **1** --- The :ref:`Joint3D<class_Joint3D>` is a :ref:`HingeJoint3D<class_HingeJoint3D>`.

- **JOINT_TYPE_SLIDER** = **2** --- The :ref:`Joint3D<class_Joint3D>` is a :ref:`SliderJoint3D<class_SliderJoint3D>`.

- **JOINT_TYPE_CONE_TWIST** = **3** --- The :ref:`Joint3D<class_Joint3D>` is a :ref:`ConeTwistJoint3D<class_ConeTwistJoint3D>`.

- **JOINT_TYPE_6DOF** = **4** --- The :ref:`Joint3D<class_Joint3D>` is a :ref:`Generic6DOFJoint3D<class_Generic6DOFJoint3D>`.

- **JOINT_TYPE_MAX** = **5** --- Represents the size of the :ref:`JointType<enum_PhysicsServer3D_JointType>` enum.
...
- **SLIDER_JOINT_MAX** = **22** --- Represents the size of the :ref:`SliderJointParam<enum_PhysicsServer3D_SliderJointParam>` enum.
...
- **SHAPE_WORLD_BOUNDARY** = **0** --- The :ref:`Shape3D<class_Shape3D>` is a :ref:`WorldBoundaryShape3D<class_WorldBoundaryShape3D>`.

- **SHAPE_SEPARATION_RAY** = **1** --- The :ref:`Shape3D<class_Shape3D>` is a :ref:`SeparationRayShape3D<class_SeparationRayShape3D>`.

- **SHAPE_SPHERE** = **2** --- The :ref:`Shape3D<class_Shape3D>` is a :ref:`SphereShape3D<class_SphereShape3D>`.

- **SHAPE_BOX** = **3** --- The :ref:`Shape3D<class_Shape3D>` is a :ref:`BoxShape3D<class_BoxShape3D>`.

- **SHAPE_CAPSULE** = **4** --- The :ref:`Shape3D<class_Shape3D>` is a :ref:`CapsuleShape3D<class_CapsuleShape3D>`.

- **SHAPE_CYLINDER** = **5** --- The :ref:`Shape3D<class_Shape3D>` is a :ref:`CylinderShape3D<class_CylinderShape3D>`.

- **SHAPE_CONVEX_POLYGON** = **6** --- The :ref:`Shape3D<class_Shape3D>` is a :ref:`ConvexPolygonShape3D<class_ConvexPolygonShape3D>`.

- **SHAPE_CONCAVE_POLYGON** = **7** --- The :ref:`Shape3D<class_Shape3D>` is a :ref:`ConcavePolygonShape3D<class_ConcavePolygonShape3D>`.

- **SHAPE_HEIGHTMAP** = **8** --- The :ref:`Shape3D<class_Shape3D>` is a :ref:`HeightMapShape3D<class_HeightMapShape3D>`.

- **SHAPE_SOFT_BODY** = **9** --- The :ref:`Shape3D<class_Shape3D>` is used internally for a soft body. Any attempt to create this kind of shape results in an error.

- **SHAPE_CUSTOM** = **10** --- This constant is used internally by the engine. Any attempt to create this kind of shape results in an error.
...
- **AREA_PARAM_GRAVITY_POINT_ATTENUATION** = **4** --- This constant was used to set/get the falloff factor for point gravity. It has been superseded by :ref:`AREA_PARAM_GRAVITY_DISTANCE_SCALE<class_PhysicsServer3D_constant_AREA_PARAM_GRAVITY_DISTANCE_SCALE>`.
...
- **AREA_PARAM_WIND_FORCE_MAGNITUDE** = **8** --- Constant to set/get the magnitude of area-specific wind force.

- **AREA_PARAM_WIND_SOURCE** = **9** --- Constant to set/get the 3D vector that specifies the origin from which an area-specific wind blows.

- **AREA_PARAM_WIND_DIRECTION** = **10** --- Constant to set/get the 3D vector that specifies the direction in which an area-specific wind blows.

- **AREA_PARAM_WIND_ATTENUATION_FACTOR** = **11** --- Constant to set/get the exponential rate at which wind force decreases with distance from its origin.
...
- **BODY_PARAM_CENTER_OF_MASS** = **4** --- Constant to set/get a body's center of mass.

- **BODY_PARAM_GRAVITY_SCALE** = **5** --- Constant to set/get a body's gravity multiplier.

- **BODY_PARAM_LINEAR_DAMP** = **6** --- Constant to set/get a body's linear dampening factor.

- **BODY_PARAM_ANGULAR_DAMP** = **7** --- Constant to set/get a body's angular dampening factor.

- **BODY_PARAM_MAX** = **8** --- Represents the size of the :ref:`BodyParameter<enum_PhysicsServer3D_BodyParameter>` enum.
...
.. _class_PhysicsServer3D_method_area_get_space_override_mode:

- :ref:`AreaSpaceOverrideMode<enum_PhysicsServer3D_AreaSpaceOverrideMode>` **area_get_space_override_mode** **(** :ref:`RID<class_RID>` area **)** |const|
...
.. _class_PhysicsServer3D_method_area_set_space_override_mode:

- void **area_set_space_override_mode** **(** :ref:`RID<class_RID>` area, :ref:`AreaSpaceOverrideMode<enum_PhysicsServer3D_AreaSpaceOverrideMode>` mode **)**

Sets the space override mode for the area. The modes are described in the :ref:`AreaSpaceOverrideMode<enum_PhysicsServer3D_AreaSpaceOverrideMode>` constants.
...
Returns the :ref:`PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>` of the body.
