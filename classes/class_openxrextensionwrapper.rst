...
.. table::
   ...
   +--------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Array<class_Array>`\[:ref:`Transform3D<class_Transform3D>`\] | :ref:`_get_camera_offsets<class_OpenXRExtensionWrapper_private_method__get_camera_offsets>`\ (\ tracker_name\: :ref:`StringName<class_StringName>`\ ) |virtual|                                                                                                                         |
   +--------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`Array<class_Array>`\[:ref:`Projection<class_Projection>`\]   | :ref:`_get_camera_projections<class_OpenXRExtensionWrapper_private_method__get_camera_projections>`\ (\ tracker_name\: :ref:`StringName<class_StringName>`, aspect\: :ref:`float<class_float>`, z_near\: :ref:`float<class_float>`, z_far\: :ref:`float<class_float>`\ ) |virtual|      |
   +--------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +--------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`int<class_int>`                                              | :ref:`_set_spatial_container_create_info_and_get_next_pointer<class_OpenXRExtensionWrapper_private_method__set_spatial_container_create_info_and_get_next_pointer>`\ (\ spatial_container\: :ref:`RID<class_RID>`, next_pointer\: ``void*``\ ) |virtual|                                |
   +--------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`int<class_int>`                                              | :ref:`_set_spatial_container_views_locate_info_and_get_next_pointer<class_OpenXRExtensionWrapper_private_method__set_spatial_container_views_locate_info_and_get_next_pointer>`\ (\ spatial_container\: :ref:`RID<class_RID>`, next_pointer\: ``void*``\ ) |virtual|                    |
   +--------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. _class_OpenXRExtensionWrapper_private_method__get_camera_offsets:

.. rst-class:: classref-method

:ref:`Array<class_Array>`\[:ref:`Transform3D<class_Transform3D>`\] **_get_camera_offsets**\ (\ tracker_name\: :ref:`StringName<class_StringName>`\ ) |virtual| :ref:`🔗<class_OpenXRExtensionWrapper_private_method__get_camera_offsets>`

Returns an array of offsets for each view rendered for the given camera, if this camera is handled by this extension. ``tracker_name`` refers to the camera tracker for which we're retrieving this.

.. rst-class:: classref-item-separator

----

.. _class_OpenXRExtensionWrapper_private_method__get_camera_projections:

.. rst-class:: classref-method

:ref:`Array<class_Array>`\[:ref:`Projection<class_Projection>`\] **_get_camera_projections**\ (\ tracker_name\: :ref:`StringName<class_StringName>`, aspect\: :ref:`float<class_float>`, z_near\: :ref:`float<class_float>`, z_far\: :ref:`float<class_float>`\ ) |virtual| :ref:`🔗<class_OpenXRExtensionWrapper_private_method__get_camera_projections>`

Returns an array of projections for each view rendered for the given camera, if this camera is handled by this extension. ``tracker_name`` refers to the camera tracker for which we're retrieving this.
...
.. _class_OpenXRExtensionWrapper_private_method__set_spatial_container_create_info_and_get_next_pointer:

.. rst-class:: classref-method

:ref:`int<class_int>` **_set_spatial_container_create_info_and_get_next_pointer**\ (\ spatial_container\: :ref:`RID<class_RID>`, next_pointer\: ``void*``\ ) |virtual| :ref:`🔗<class_OpenXRExtensionWrapper_private_method__set_spatial_container_create_info_and_get_next_pointer>`

Add additional data structures when the spatial container is created.

.. rst-class:: classref-item-separator

----

.. _class_OpenXRExtensionWrapper_private_method__set_spatial_container_views_locate_info_and_get_next_pointer:

.. rst-class:: classref-method

:ref:`int<class_int>` **_set_spatial_container_views_locate_info_and_get_next_pointer**\ (\ spatial_container\: :ref:`RID<class_RID>`, next_pointer\: ``void*``\ ) |virtual| :ref:`🔗<class_OpenXRExtensionWrapper_private_method__set_spatial_container_views_locate_info_and_get_next_pointer>`

Add additional data structures to ``XrSpatialContainerViewsLocateInfoEXT`` for the spatial container specified by ``spatial_container``.
