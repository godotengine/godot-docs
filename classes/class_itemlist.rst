...
.. table::
   ...
   +-----------------------------------+--------------------------------------------------------------------------------------------+-------------------------------------+
   | :ref:`int<class_int>`             | :ref:`scroll_bar_h_separation<class_ItemList_theme_constant_scroll_bar_h_separation>`      | ``4``                               |
   +-----------------------------------+--------------------------------------------------------------------------------------------+-------------------------------------+
...
.. _class_ItemList_theme_constant_scroll_bar_h_separation:

.. rst-class:: classref-themeproperty

:ref:`int<class_int>` **scroll_bar_h_separation** = ``4`` :ref:`🔗<class_ItemList_theme_constant_scroll_bar_h_separation>`
