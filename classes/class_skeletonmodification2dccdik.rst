...
.. DO NOT EDIT THIS FILE, but the SkeletonModification2DCCDIK.xml source instead.
...
This :ref:`SkeletonModification2D<class_SkeletonModification2D>` uses an algorithm called **C**yclic **C**oordinate **D**escent **I**nverse **K**inematics, or CCDIK, to manipulate a chain of bones in a :ref:`Skeleton2D<class_Skeleton2D>` so it reaches a defined target.
