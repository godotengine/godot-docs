...
See `Running code in the editor <https://docs.godotengine.org/en/latest/tutorials/plugins/running_code_in_the_editor.html>`_ in the documentation for more information.
