...
- **AUDIO_OUTPUT_LATENCY** = **27** --- Output latency of the :ref:`AudioServer<class_AudioServer>`.

- **MONITOR_MAX** = **28** --- Represents the size of the :ref:`Monitor<enum_Performance_Monitor>` enum.
