...
:ref:`PopupMenu<class_PopupMenu>` is a :ref:`Control<class_Control>` that displays a list of options. They are popular in toolbars or context menus.
...
If ``true``, hides the :ref:`PopupMenu<class_PopupMenu>` when a checkbox or radio button is selected.
...
If ``true``, hides the :ref:`PopupMenu<class_PopupMenu>` when an item is selected.
...
If ``true``, hides the :ref:`PopupMenu<class_PopupMenu>` when a state item is selected.
...
Adds an item that will act as a submenu of the parent :ref:`PopupMenu<class_PopupMenu>` node when clicked. The ``submenu`` argument is the name of the child :ref:`PopupMenu<class_PopupMenu>` node that will be shown when the item is clicked.
...
Removes all items from the :ref:`PopupMenu<class_PopupMenu>`.
...
Returns the number of items in the :ref:`PopupMenu<class_PopupMenu>`.
...
Hides the :ref:`PopupMenu<class_PopupMenu>` when the window loses focus.
...
Sets the submenu of the item at index ``idx``. The submenu is the name of a child :ref:`PopupMenu<class_PopupMenu>` node that would be shown when the item is clicked.
