...
.. DO NOT EDIT THIS FILE, but the SkeletonModification2DFABRIK.xml source instead.
...
This :ref:`SkeletonModification2D<class_SkeletonModification2D>` uses an algorithm called **F**orward **A**nd **B**ackward **R**eaching **I**nverse **K**inematics, or FABRIK, to rotate a bone chain so that it reaches a target.
