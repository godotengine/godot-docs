...
If you're feeling lost by now, come to our `Contributors Chat <https://chat.godotengine.org/>` and ask for help. Experienced Git users will give you a hand.
...
You can still have a look at the methods' implementation in Godot's source code on GitHub. Also, if you have doubts, feel free to ask on the `Q&A website <https://godotengine.org/qa/>`__ and on the `Contributors Chat
