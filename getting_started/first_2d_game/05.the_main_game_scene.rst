...
Once all three timers have this set up, you should be able to see that each
timer has a Signal connection for its respective ``timeout()`` signal, showing
in green, within its respective Signals tab:
