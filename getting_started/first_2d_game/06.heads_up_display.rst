...
1. Under "Theme Overrides > Fonts", choose "New FontVariation".

.. image:: img/custom_font1.webp

2. Click on the "FontVariation" you added, and under "Base Font",
   choose "Load" and select the "Xolonium-Regular.ttf" file.

.. image:: img/custom_font2.webp
