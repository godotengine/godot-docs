...
**Note**: Godot also provides the :ref:`CharacterBody2D <class_CharacterBody2D>` node, 
...
would be a better choice for a players and enemies. However, this tutorial focus on 
