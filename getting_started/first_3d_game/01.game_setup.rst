...
Click *Import & Edit* to open the project in the editor. Another window will appear prompting you to update the project. Click *Convert Full Project* and then click *Ok* in the next window.
