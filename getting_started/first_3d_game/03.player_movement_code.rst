...
Then, we update the velocity and position. We have to calculate the ground velocity and the
...
``19`` units on the Z axis (drag the blue arrow) then ``9`` units on the Y axis (drag the green arrow).
