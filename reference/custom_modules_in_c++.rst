...
This allows for some powerful possibilities using python to contruct the file list using loops and logic statements. Look at some of the other modules that ship with Godot by default for examples. 
